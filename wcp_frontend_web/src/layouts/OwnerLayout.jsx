...
const OwnerLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/owner/properties', label: 'Mes Biens', icon: 'Building2' },
        { path: '/owner/finances', label: 'Finances', icon: 'Wallet' },
        { path: '/owner/add-property', label: 'Ajouter un bien', icon: 'Plus' },
        { path: '/owner/settings', label: 'Paramètres', icon: 'Settings' },
    ];
        ...
        <div className="min-h-screen bg-slate-50 flex">
            ...
            `}>
                ...
                >
                    ...
                    <span className="text-xl font-bold text-white tracking-tight">WCP Propriétaire</span>
                </button>
                ...
                <div className="p-6">
                    <div className="flex items-center gap-3 mb-8 px-2">
                        ...
                        <div className="overflow-hidden">
                            <p className="text-sm font-bold text-white truncate">{ownerProfile.name}</p>
                            <p className="text-[10px] text-slate-400 uppercase font-black">Propriétaire</p>
                        </div>
                    </div>
                ...
                <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-30 shadow-sm sm:px-8">
                    <div className="flex items-center">
                        ...
                        <div className="hidden lg:block">
                            <h2 className="text-lg font-bold text-slate-900">Bienvenue, {ownerProfile.name.split(' ')[0]}</h2>
                            <p className="text-xs text-slate-500">Gérez votre patrimoine immobilier en toute simplicité</p>
                        </div>
                    </div>

                    <div className="flex items-center space-x-4">
                        <div className="hidden sm:flex flex-col items-end px-4 py-2 bg-slate-50 rounded-lg">
                            <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest">Portfolio</p>
                            <p className="text-sm font-bold text-blue-600">{ownerProfile.propertiesCount} biens</p>
                        </div>
