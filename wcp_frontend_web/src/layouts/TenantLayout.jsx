...
import tenantProfile from '../api/tenantProfile';
...
const TenantLayout = () => {
    ...
    const navItems = [
        { name: 'Tableau de Bord', path: '/tenant', icon: 'LayoutDashboard', exact: true },
        { name: 'Documents', path: '/tenant/documents', icon: 'FileText' },
        { name: 'Maintenance', path: '/tenant/maintenance', icon: 'Wrench' },
        { name: 'Mon Bail', path: '/tenant/lease', icon: 'Info' },
        ...
        <div className="min-h-screen bg-slate-50 flex">
            ...
            `}>
                ...
                >
                    ...
                    <span className="text-xl font-bold text-white tracking-tight">WCP Locataire</span>
                </button>
                ...
                <div className="p-6">
                    <div className="flex items-center gap-3 mb-8 px-2">
                        ...
                        <div className="overflow-hidden">
                            ...
                            <p className="text-[10px] text-slate-400 uppercase font-black">Locataire</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden lg:block">
                            <h2 className="text-lg font-bold text-slate-900">
                                Bonjour, {tenantProfile.firstName}
                            </h2>
                            <p className="text-xs text-slate-500">{tenantProfile.property.address}</p>
                        </div>
                    </div>

                    <div className="flex items-center space-x-4">
                        <div className="hidden sm:flex flex-col items-end px-4 py-2 bg-slate-50 rounded-lg">
                            <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest">Prochain loyer</p>
                            <p className="text-sm font-bold text-blue-600">{tenantProfile.currentRent.toLocaleString()} FCFA</p>
                        </div>
